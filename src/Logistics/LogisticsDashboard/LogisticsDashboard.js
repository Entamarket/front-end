...
const LogisticsDashboard = () => {
  ...
  const cofirmDeliveryHandler = () => {
    fetch(`${apiUrl}logistics/confirm-delivery?checkoutID=${checkoutID}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${entamarketToken}`,
        "Content-Type": "application/json",
              ...
              return (
                <div key={orderData.product._id}>
                  ...
                  <div className="acct__details-box">
                    <p>
                      Note Click this button when an order have been delivered
                      to the customer.
                    </p>
                    <button className="btn-pay" onClick={cofirmDeliveryHandler}>
                      Confirm Delivery
                    </button>
                  </div>
                </div>
