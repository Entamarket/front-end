  ...
  return (
    <div className="Trader_dashboard">
                ...
                <div key={orderData.product._id}>
                  ...
                  <div className="confirm__box">
                    <p className="note__text">
                      <span>Note</span>: Click the button below after product
                      have been delivered to you to confirm delivery
                    </p>
                    ...
                    return (
                      <div className="pend-box1main" key={purchase._id}>
                        <div className="pending__buyerbox">
                          ...
                          <p>Your order have been sent awaiting Delivery</p>
      ...
      <div className="traderdashboard__footer">
        <p>Entamarket Limited Buyer Dashboard</p>
